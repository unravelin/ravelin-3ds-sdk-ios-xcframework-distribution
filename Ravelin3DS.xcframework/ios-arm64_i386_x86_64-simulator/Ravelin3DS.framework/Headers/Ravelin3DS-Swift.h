...
///
/// \param paramGroup The group to which this parameter will be added. If <code>nil</code> the parameter will be added to kConfigDefaultGroupName`
///
///
/// throws:
/// InvalidInput  if <code>paramName</code> or <code>paramValue</code> are <code>empty</code> or an entry already exists
- (BOOL)addParam:(NSString * _Nonnull)paramName value:(NSString * _Nonnull)paramValue group:(NSString * _Nullable)paramGroup error:(NSError * _Nullable * _Nullable)error;
@end
